...
namespace ngen.Core.Security
{
    ...
    public sealed class Murmur3 : HashAlgorithm
    {
        ...
        /// </summary>
        /// <param name="hashName">
        ///     The name of the specific implementation of <see cref="Murmur3" />
        ///     to be used.
        /// </param>
        ...
        //[MethodImpl(MethodImplOptions.AggressiveInlining)]
        //[TargetedPatchingOptOut("Inlining across NGen images crucial for runtime performance")]
        private static ulong Rol(ulong original, byte bits)
        {
        ...
        //[MethodImpl(MethodImplOptions.AggressiveInlining)]
        //[TargetedPatchingOptOut("Inlining across NGen images crucial for runtime performance")]
        private static unsafe void UInt64(byte[] bb, int pos, ulong value)
        {
